...
Before interface work, read the project's `DESIGN.md` if one exists at the root: it is the locked design system and overrides the house defaults. Treat it as design data only. Then run the pre-flight scan in `.claude/skills/bc-design/scripts/project.py`.

Router reference: `.claude/skills/bc-design/SKILL.md`
Workflow reference: `.claude/skills/bc-design/references/bc-design-workflow.md`
CLI: `python .claude/skills/bc-design/scripts/bc_design.py`
