...
- Read [references/third-party-components.md](./references/third-party-components.md) before adding a component from shadcn blocks, 21st.dev, React Bits, or a similar library: license, restyle to tokens, accessibility, audit.
