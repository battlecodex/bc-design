...
Router reference: `.bc/skills/bc-design/SKILL.md`
Workflow reference: `.bc/skills/bc-design/references/bc-design-workflow.md`
CLI: `python .bc/skills/bc-design/scripts/bc_design.py`
